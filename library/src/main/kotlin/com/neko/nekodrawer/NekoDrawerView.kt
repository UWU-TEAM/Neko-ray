 ...
 */
class NekoDrawerView : DrawerLayout {
    ...
    var mNekoDrawerEvents: NekoDrawerEvents? = null

    @SuppressLint("CustomViewStyleable")
    constructor(context: Context, attrs: AttributeSet?) : this(context, attrs, 0) {
        val arr = context.obtainStyledAttributes(attrs, R.styleable.NekoDrawerView)
        val sliderType = arr.getInt(R.styleable.NekoDrawerView_sliderType, 0)
    ...
    fun setDrawerView(slideType: Int) {
        ...
        drawerListener = object : DrawerLayout.DrawerListener {
            ...
            override fun onDrawerOpened(drawerView: View) {
                if (mNekoDrawerEvents != null) {
                    mNekoDrawerEvents?.onDrawerOpened(drawerView)
                }
            }

            override fun onDrawerClosed(drawerView: View) {
                if (mNekoDrawerEvents != null) {
                    mNekoDrawerEvents?.onDrawerClosed(drawerView)
                }
            }
     ...
     */
    fun setNekoDrawerListener(mDrawerEvents: NekoDrawerEvents) {
        this.mNekoDrawerEvents = mDrawerEvents
    }

    /**
     * Interface for the drawer events.
     */
    public interface NekoDrawerEvents {
