 ...
 *              Enjoy.
 */
public abstract class AnalogClock extends RelativeLayout {
     ...
     */
    public AnalogClock setCalendar(Calendar calendar) {
     ...
     */
    public AnalogClock setScale(float scale) {
        this.scale = scale;
     ...
     */
    public AnalogClock setDiameterInDp(float diameterInDp){
     ...
     */
    public AnalogClock setDiameterInPixels(int diameterInPixels){
     ...
     *               Default: 1.0f
     */
    public AnalogClock setOpacity(float opacity) {
     ...
     */
    public AnalogClock setColor(int color) {
        this.color = color;
        main(ctx);
     ...
     */
    public AnalogClock setShowSeconds(boolean showSeconds) {
    ...
    private void main(Context ctx) {
        ...
        inflate(ctx,R.layout.uwu_analog_clock,this);
