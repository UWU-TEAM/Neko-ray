...
class UbahActivity : BaseActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        getUsername = terima.getStringExtra("varUsername") ?: ""
    ...
    private fun updateDataUwu(): Boolean {
        ...
        val txtUsername = etUsername.text.toString()
        ...
        when {
            ...
            txtUsername.trim().isEmpty() -> {
                val builder = MaterialAlertDialogBuilder(this)
                builder.setMessage(getString(R.string.uwu_username_dialog))
                .setCancelable(false)
                .setPositiveButton(R.string.ok, null)
                .show()
            }
            ...
            txtTgl.trim().isEmpty() -> {
                ...
                val eksekusi = myDB.ubahDatabase(getID, txtName, txtUsername, txtEmail, txtAge, txtHobi, txtTgl)
