...
public class NekoSimpelActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.neko_simpel_activity);
        if (savedInstanceState == null) {
            V2rayController.init(this, R.drawable.anggit, "V2ray Android");
